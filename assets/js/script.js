...
let jsonObject = window.json || {
    ...
    embed: {
        ...
        description: "You can use [links](https://plexybot.xyz/support/) or emojis :smile: 😎\n```\nAnd also code blocks\n```",
        color: 0x41f097,
        timestamp: new Date().toISOString(),
        url: "https://plexybot.xyz/support/",
        author: {
            name: "Author name",
            url: "https://plexybot.xyz/support/",
        ...
        image: {
            url: "https://plexybot.xyz/embed-builder/assets/media/banner.png"
        },
        footer: {
            text: "Footer text",
